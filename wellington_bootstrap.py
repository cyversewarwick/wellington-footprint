...
class Diffwell(pyDNase.footprinting.wellington):
    ...
    def findDiffFP(self):
        ...
        for i in offsets:
            ...
            fp_halfsize = (best_footprintsizes[int(i[0])] // 2)
            left = middle - fp_halfsize
            right = middle + fp_halfsize
            ml_score = best_probabilities[int(i[0])]
